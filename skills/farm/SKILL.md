...
already knows the value. Test named and unnamed constraints against what you verified
with the user at triage; a new one you're unsure of goes to the user, and the answer joins your
running list.
